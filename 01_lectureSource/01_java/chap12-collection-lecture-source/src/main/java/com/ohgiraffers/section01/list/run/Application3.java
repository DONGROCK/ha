...
public class Application3 {
    ...
    /*
    * LinkedList
    *  - ArrayList가 배열을 이용해서 발생할 수 있는 성능적인 단점을 보안하고자 고안되었다.
    * 내부는 이중 연결리스트로 구현되어 있다.
    *
    * 단일 연결 리스트
    * : 저장한 요소 순서를 유지하지 않고 저장되지만 이러한 요소들 사이를 링크로 연결하여 구성하며
    ...
    * */
    public static void main(String[] args) {
        ...
        linkedList.set(0, "강아지");

        System.out.println("linkedList = " + linkedList);

        System.out.println(linkedList.isEmpty()); //값 들어있냐.. 있다
