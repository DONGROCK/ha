...
public class Application4 {
    public static void main(String[] args) {
        ...
        System.out.println("안녕하세요.\t탭입니다.");
        System.out.println("안녕하세요.\'작은따옴표\'입니다.");
        System.out.println('\'');
        System.out.println("안녕하세요.\"큰따옴표\"입니다.");
        System.out.println("\"");
        ...
        */
        ...
        정규표현식에서 사용되는 특수문자인 경우 \$가 정규표현식 문자와 겹치게 된다.
                따라서 $를 기준으로 split 을 하기 위해서는 정규표현식 문자가 아닌 $라는
                 구분자로 split 하겠다는 의미로 사용되려면 구분문자를 \$로 표현해야 한다.
